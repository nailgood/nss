...
{
	/// <summary>
	/// psHttp Utility class to provide UrlEncoding without the need to use
	/// the System.Web libraries (too much overhead)
	/// </summary>
	public class vtHttpUtils 
	{
		/// <summary>
		...
		public static string GetUrlEncodedKey(string UrlEncodedString, string Key) 
		{
			...
			string Result = vtHttpUtils.UrlDecode(UrlEncodedString.Substring(lnStart,Index2 - lnStart));
