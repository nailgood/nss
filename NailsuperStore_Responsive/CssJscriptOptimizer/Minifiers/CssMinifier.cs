...
namespace CssJscriptOptimizer.Minifiers
{
	public static class CssMinifier
	{
		...
		public static string CssMinify(this string css, int columnWidth)
		{
           ...
           // css = css.Replace("/Styles/image", "/image");
            //''/Styles/image
			if (columnWidth > 0)
			{
			...
			css = css.RegexReplace("___PSEUDOCLASSBMH___", "\"\\\\\"}\\\\\"\"");
			css = css.Trim();
            css = css.Replace("and(-webkit-min-device-pixel-ratio:10000)", "and (-webkit-min-device-pixel-ratio:10000)");
            css = css.Replace("and(-webkit-min-device-pixel-ratio:0)", "and (-webkit-min-device-pixel-ratio:0)");
			return css;
		}
