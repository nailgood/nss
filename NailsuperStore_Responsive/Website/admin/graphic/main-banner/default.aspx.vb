...
Partial Class admin_graphic_main_banner_default
    Inherits AdminPage
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            rbtnEffect.DataSource = dt
            rbtnEffect.DataTextField = "Name"
            rbtnEffect.DataValueField = "Code"
            rbtnEffect.DataBind()
            BindList()
        End If
    End Sub
    ...
    Protected Sub btnSaveEffect_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSaveEffect.Click
        If Page.IsValid Then
            ...
            If departmentId < 1 Then
                ...
                Exit Sub
            End If
            If String.IsNullOrEmpty(rbtnEffect.SelectedValue) Then
            ...
            data.EffectCode = rbtnEffect.SelectedValue
