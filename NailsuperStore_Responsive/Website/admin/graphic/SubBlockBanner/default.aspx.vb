...
Partial Class admin_graphic_SubBlockBanner_Default
    Inherits AdminPage
    ...
    Private Sub BindList()
        Dim lstBanner As InforBannerCollection = InforBannerRow.GetAllByType(Utility.Common.InforBannerType.SubBlockBanner)
    ...
    Protected Sub gvList_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvList.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If Not String.IsNullOrEmpty(objBanner.Image) Then
                ltrImage.Text = "<img src='" & Utility.ConfigData.PathSubBlockBanner & "/thumb/" & objBanner.Image & "?t=" & DateTime.Now.ToString() & "' width='100px'/>"
            End If
