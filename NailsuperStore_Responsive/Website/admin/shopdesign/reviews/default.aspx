<%@ Page Title="" Language="VB" MasterPageFile="~/includes/masterpage/admin.master" AutoEventWireup="false" CodeFile="default.aspx.vb" Inherits="admin_shopdesign_reviews_default" %>
...
<h4>Shop Design Reviews</h4>
        ...
        <table cellpadding="2" cellspacing="2">
            <tr>
                ...
                <td valign="top" class="field">
                    <asp:DropDownList ID="F_ShopDesignCategory" runat="server">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
    ...
    <CC:GridView ID="gvList" CellSpacing="2" CellPadding="2" runat="server" PageSize="50"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Shop Design" ControlStyle-CssClass="" ItemStyle-Width="280">
                <ItemTemplate>
                    <asp:Literal ID="ltrShopDesign" runat="server"></asp:Literal>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField ItemStyle-HorizontalAlign="right">
                <ItemTemplate>
                    <asp:ImageButton ID="imbDelete" runat="server" ImageUrl="/includes/theme-admin/images/delete.gif"
                        CommandName="Delete" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ReviewId")%>' OnClientClick="return ConfirmDelete();" />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </CC:GridView>
