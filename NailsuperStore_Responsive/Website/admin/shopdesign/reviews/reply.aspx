<%@ Page Title="" Language="VB" MasterPageFile="~/includes/masterpage/admin.master" AutoEventWireup="false" CodeFile="reply.aspx.vb" Inherits="admin_shopdesign_reviews_reply" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ph" Runat="Server">
<h4> Shop Design Reviews Reply</h4>
        ...
        <table cellpadding="2" cellspacing="2">
            ...
            <tr >
                ...
                <td valign="top" class="field" style="width:500px;">
                   <asp:Label ID="lblShopDesign" runat="server"></asp:Label>
                </td>
            </tr>
             <tr>
                <th valign="top">
    ...
    <input type="hidden" id="hidCon" value="" runat="server" />
    <p>
    </p>
        ...
        <Columns>
            ...
            <asp:TemplateField ItemStyle-HorizontalAlign="right">
                ...
                <asp:ImageButton ID="imbDelete" runat="server" ImageUrl="/includes/theme-admin/images/delete.gif"
                        CommandName="Delete" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ReviewId")%>' />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </CC:GridView>
