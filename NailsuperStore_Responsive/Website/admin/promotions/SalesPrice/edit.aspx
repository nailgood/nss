...
<h4><% If SalesPriceId = 0 Then%>Add<% Else %>Edit<% End If %> Top Sale Price</h4>
...
<table border="0" cellspacing="1" cellpadding="2">
	...
	<tr>
		...
		<td><asp:RequiredFieldValidator ID="rfvSKU" runat="server" Display="Dynamic" ControlToValidate="txtSKU" CssClass="msgError" ErrorMessage="Field 'SKU' is blank"></asp:RequiredFieldValidator></td>
	</tr>
	<tr>
