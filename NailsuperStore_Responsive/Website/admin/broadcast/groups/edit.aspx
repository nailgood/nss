<%@ Page Language="VB" AutoEventWireup="false" CodeFile="edit.aspx.vb" MasterPageFile="~/includes/masterpage/admin.master" Inherits="admin_broadcast_groups_edit"  Title="Mailing Group"%>
...
<table border="0" cellspacing="1" cellpadding="2">
    ...
    <td>
    <CC:DateValidator Display="Dynamic" runat="server" id="dtvStartDate" ControlToValidate="dtStartDate" CssClass="msgError" ErrorMessage="Date Field 'Start Date' is invalid" />
    <CC:DateValidator Display="Dynamic" runat="server" id="dtvEndDate" ControlToValidate="dtEndDate" CssClass="msgError" ErrorMessage="Date Field 'End Date' is invalid" />
	</td>
	</tr>
</table>
