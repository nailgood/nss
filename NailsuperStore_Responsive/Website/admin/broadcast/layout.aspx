<%@ Page ValidateRequest="False" Language="VB" AutoEventWireup="false" MasterPageFile="~/includes/masterpage/admin.master" Title="Mailing Message" CodeFile="layout.aspx.vb" Inherits="admin_broadcast_layout"  %>
...
<tr>
	...
	<td>
	    <CC:RequiredDateValidator ID="reqDateValidator1" ControlToValidate="dtNewsletterDate" CssClass="msgError" ErrorMessage="E-mail date is blank" runat="server" Display="Dynamic" />
	    <CC:DateValidator ID="DateValidator1" ControlToValidate="dtNewsletterDate" CssClass="msgError" ErrorMessage="E-mail date is invalid" runat="server" Display="Dynamic" />
	</td>
</tr>
...
<tr>
	...
	<td><CC:EmailValidator ID="valFromEmail" ControlToValidate="txtFromEmail" CssClass="msgError" ErrorMessage="From E-mail is invalid" runat="server" /></td>
</tr><tr>
	<td class="required" style="width:100px;">From Name:</td>
	<td class="field" valign="top">
	<asp:TextBox id="txtFromName" columns="50" maxlength="100" runat="server" />
	</td>
	<td><asp:RequiredFieldValidator ID="reqValidator1" ControlToValidate="txtFromName" CssClass="msgError" ErrorMessage="From Name is blank" runat="server" /></td>
</tr><tr>
	<td class="required" style="width:100px;">Reply-To Email:</td>
	<td class="field" valign="top">
	<asp:TextBox id="txtReplyEmail" columns="50" maxlength="100" runat="server" />
	</td>
	<td><CC:EmailValidator ID="EmailValidator2" ControlToValidate="txtReplyEmail" CssClass="msgError" ErrorMessage="Reply-To Email is invalid" runat="server" /></td>
</tr><tr>
	...
	<td><asp:RequiredFieldValidator ID="reqValidator2" ControlToValidate="txtSubject" CssClass="msgError" ErrorMessage="Subject is blank" runat="server" /></td>
</tr><tr>
...
<tr>
	...
	<asp:TextBox id="htmSlot" runat="server" Width="600" Height="300" TextMode="MultiLine" />
