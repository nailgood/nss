<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/includes/masterpage/admin.master" Title="Mailing Message" CodeFile="default.aspx.vb" Inherits="admin_broadcast_reports_index"  %>
...
<td>
<CC:DateValidator ID="DateValidator1" runat="server" Display="Dynamic" ControlToValidate="F_SentDateLbound" CssClass="msgError" ErrorMessage="Invalid 'From date'"></CC:DateValidator>
