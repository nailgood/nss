<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/includes/masterpage/admin.master" Title="Mailing Message" CodeFile="recipients.aspx.vb" Inherits="admin_broadcast_Recipients"  %>
