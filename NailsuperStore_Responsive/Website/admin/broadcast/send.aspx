<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/includes/masterpage/admin.master" Title="Mailing Message" CodeFile="send.aspx.vb" Inherits="admin_broadcast_SendSchedule"  %>
...
<tr>
	...
	<td><CC:DateValidator ID="DateValidator1" runat="server" Display="Dynamic" ControlToValidate="ScheduledDate" CssClass="msgError" ErrorMessage="Invalid 'Scheduled Date'"></CC:DateValidator></td>
</tr>
<tr>
	<td class="optional"><b>Scheduled Time:</b></td>
	<td class="field"><CC:TimePicker id="ScheduledTime" runat="server" /></td>
	<td><CC:TimeValidator runat="server" ID="TimeVal1" Display="Dynamic" ControlToValidate="ScheduledTime" CssClass="msgError" ErrorMessage="Invalid 'Scheduled Time'"></CC:TimeValidator></td>
</tr>
</table>

<asp:CustomValidator Display="None" CssClass="msgError" ErrorMessage="Both, scheduled date and time must be empty or entered at the same time" ID="valCustom" runat="server"></asp:CustomValidator>
