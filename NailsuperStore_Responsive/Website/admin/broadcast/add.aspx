<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/includes/masterpage/admin.master" Title="Mailing Message" CodeFile="add.aspx.vb" Inherits="admin_broadcast_add"  %>
...
<asp:CustomValidator Display="none" EnableClientScript="false" ID="valCustom" runat="server" CssClass="msgError" ErrorMessage="Please select a template or a list to copy from"></asp:CustomValidator>
<asp:CustomValidator Display="none" EnableClientScript="false" ID="valTarget" runat="server" CssClass="msgError" ErrorMessage="Please select the type of email recipients"></asp:CustomValidator>
