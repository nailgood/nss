<%@ Page Language="VB" AutoEventWireup="false" CodeFile="edit.aspx.vb" MasterPageFile="~/includes/masterpage/admin.master" Inherits="admin_broadcast_lists_Edit"  Title="Mailing List"%>
...
<table border="0" cellspacing="1" cellpadding="2">
	...
	<tr>
		...
		<td><asp:RequiredFieldValidator ID="rfvName" runat="server" Display="Dynamic" ControlToValidate="txtName" CssClass="msgError" ErrorMessage="Field 'Name' is blank"></asp:RequiredFieldValidator></td>
		</td>
	</tr>
	<tr valign="top">
	...
	<tr>
		...
		<td><CC:RequiredFileUploadValidator Display="dynamic" ID="rfuvfileName" ControlToValidate = "fuFilename" runat="server" CssClass="msgError" ErrorMessage="File is required"></CC:RequiredFileUploadValidator>
			<CC:FileUploadExtensionValidator Extensions="txt,csv" ID="vExtFileName" runat="server" Display="Dynamic" ControlToValidate="fuFilename" CssClass="msgError" ErrorMessage="Invalid file extension"></CC:FileUploadExtensionValidator>
		</td>	
	</tr>
		<tr>
		...
		<td>
		<asp:RequiredFieldValidator ID="rfvStatus" runat="server" Display="Dynamic" ControlToValidate="drpStatus" CssClass="msgError" ErrorMessage="Field 'Status' is blank"></asp:RequiredFieldValidator></td>
	</tr>
</table>
