...
Partial Class admin_broadcast_layout
    Inherits AdminPage
        ...
        Try
            ...
            For Each row As RepeaterItem In rptSlots.Items
                ...
                If rblMimeType.SelectedValue = "HTML" Or rblMimeType.SelectedValue = "BOTH" Then
                    Dim htmSlot As TextBox = row.FindControl("htmSlot")
                    Text = htmSlot.Text
                    Text = Replace(Text, ConfigurationManager.AppSettings("GlobalRefererName") & "/UserFiles/", "/UserFiles/")
                    Text = Replace(Text, "/UserFiles/", ConfigurationManager.AppSettings("GlobalRefererName") & "/UserFiles/")
                Else
    ...
    Protected Sub RefreshControls()
        For Each row As RepeaterItem In rptSlots.Items
            Dim htmSlot As TextBox = row.FindControl("htmSlot")
            Dim txtSlot As TextBox = CType(row.FindControl("txtSlot"), TextBox)
            If rblMimeType.SelectedValue = "HTML" Or rblMimeType.SelectedValue = "BOTH" Then
    ...
    Protected Sub rptSlots_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles rptSlots.ItemDataBound
        ...
        If rblMimeType.SelectedValue = "HTML" Or rblMimeType.SelectedValue = "BOTH" Then
            Dim htmSlot As TextBox = e.Item.FindControl("htmSlot")
            htmSlot.Text = Slot
        Else
