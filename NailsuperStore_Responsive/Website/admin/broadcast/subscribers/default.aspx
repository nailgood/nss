<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/includes/masterpage/admin.master" Title="Mailing Member" CodeFile="default.aspx.vb" Inherits="admin_broadcast_subscribers_index"  %>
...
<td>
<CC:DateValidator runat="server" ID="dvJoinDate_Lower" Display="Dynamic" ControlToValidate="F_JoinDate_Lower" CssClass="msgError" ErrorMessage="Field 'Join Date From' is invalid" ></CC:DateValidator><br />
<CC:DateValidator runat="server" ID="dvJoinDate_Upper" Display="Dynamic" ControlToValidate="F_JoinDate_Upper" CssClass="msgError" ErrorMessage="Field 'Join Date To' is invalid" ></CC:DateValidator>
</td>
</tr>
<tr>
...
<CC:GridView id="gvList" CellSpacing="2" CellPadding="2" runat="server" PageSize="50" AllowPaging="True" AllowSorting="True" HeaderText="In order to change display order, please use header links" EmptyDataText="There are no records that match the search criteria" AutoGenerateColumns="False" BorderWidth="0" PagerSettings-Position="Bottom">
	...
	<Columns>
		...
		<asp:TemplateField>
			<ItemTemplate>
			<CC:ConfirmLink enableviewstate=False Message="Are you sure that you want to remove this Mailing Member?" runat="server" NavigateUrl= '<%# "delete.aspx?MemberId=" & DataBinder.Eval(Container.DataItem, "MemberId") & "&" & GetPageParams(Components.FilterFieldType.All) %>' ImageUrl="/includes/theme-admin/images/delete.gif" ID="lnkDelete">Delete</CC:ConfirmLink>
			</ItemTemplate>
		</asp:TemplateField>
