<%@ Page Language="VB" AutoEventWireup="false" CodeFile="edit.aspx.vb" MasterPageFile="~/includes/masterpage/admin.master" Inherits="admin_broadcast_subscribers_Edit"  Title="Mailing Member"%>
...
<table border="0" cellspacing="1" cellpadding="2">
	...
	<tr>
		...
		<td><asp:RequiredFieldValidator ID="rfvEmail" runat="server" Display="Dynamic" ControlToValidate="txtEmail" CssClass="msgError" ErrorMessage="Field 'Email' is blank"></asp:RequiredFieldValidator></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><asp:RequiredFieldValidator ID="rfvMimeType" runat="server" Display="Dynamic" ControlToValidate="rblMimeType" CssClass="msgError" ErrorMessage="Field 'E-mail format' is blank"></asp:RequiredFieldValidator></td>
	</tr>
	<tr>
