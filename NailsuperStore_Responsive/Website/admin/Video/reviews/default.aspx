<%@ Page Title="" Language="VB" MasterPageFile="~/includes/masterpage/admin.master" AutoEventWireup="false"
    CodeFile="default.aspx.vb" Inherits="admin_Video_reviews_default" %>
...
<asp:Content ContentPlaceHolderID="ph" ID="Content" runat="server">
        ...
        <table cellpadding="2" cellspacing="2">
            <tr>
                ...
                <td valign="top" class="field">
                    <asp:DropDownList ID="F_VideoCategory" runat="server">
                    </asp:DropDownList>
                </td>
            </tr>
            <%--<tr>
                ...
                <td valign="top" class="field">
                    <asp:DropDownList ID="F_Video" runat="server">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
    ...
    <CC:GridView ID="gvList" CellSpacing="2" CellPadding="2" runat="server" PageSize="50"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Video" ControlStyle-CssClass="" ItemStyle-Width="280">
                <ItemTemplate>
                    <asp:Literal ID="ltrVideoName" runat="server"></asp:Literal>
                </ItemTemplate>
            </asp:TemplateField>
