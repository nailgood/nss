<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="admin_Video_Video_Default" MasterPageFile="~/includes/masterpage/admin.master"%>
...
<asp:Content ContentPlaceHolderID="ph" ID="Content" runat="server">
    ...
    <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server">
        ...
        <tr>
                ...
                <td valign="top" class="field">
                    <asp:DropDownList ID="F_Category" runat="server"></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <th valign="top">
    ...
    <p></p>
    <CC:OneClickButton ID="AddNew" runat="server" Text="Add New Video" CssClass="btn"></CC:OneClickButton>
    <p></p>
        ...
        <Columns>           
            <asp:TemplateField HeaderText="Name" HeaderStyle-Width="250">
                <ItemTemplate>
                    ...
                    <br />
                    <a target=_blank href="<%# "/embed/how-to-video/" & DataBinder.Eval(Container.DataItem, "VideoId")  %>" > <%#"/embed/how-to-video/" & DataBinder.Eval(Container.DataItem, "VideoId")%></a>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Related Video">
                <ItemTemplate>
                    <asp:Literal ID="ltrRelated" runat="server"></asp:Literal>
                </ItemTemplate>
              </asp:TemplateField>
              <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Related Item">
                <ItemTemplate>
                    <asp:Literal ID="ltrRelatedItem" runat="server"></asp:Literal>
                </ItemTemplate>
              </asp:TemplateField>
              <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Like FB">
                <ItemTemplate>
                    <asp:Literal ID="ltrLikeFB" runat="server"></asp:Literal>
                </ItemTemplate>
              </asp:TemplateField>
