<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/includes/masterpage/admin.master" Title="Store Promotion" CodeFile="default.aspx.vb" Inherits="Index"  %>
<asp:content ContentPlaceHolderId="ph" ID="Content" runat="server">

<h4>Product Coupon</h4>
...
<tr>
<th valign="top">Customer Price Group:</th>
<td valign="top" class="field">
...
<th valign="top"><b>Is One Use:</b></th>
<td valign="top" class="field">
...
<th valign="top"><b>Is Used:</b></th>
<td valign="top" class="field">
	<asp:DropDownList ID="F_IsUsed" runat="server">
		<asp:ListItem Value="">-- ALL --</asp:ListItem>
		<asp:ListItem Value="1">Yes</asp:ListItem>
		<asp:ListItem Value="0">No</asp:ListItem>
	</asp:DropDownList> <span class="smaller">single use only</span>
</td>
</tr>
<tr>
...
<tr>
<th valign="top"><b>Is Register Send:</b></th>
<td valign="top" class="field">
...
<tr>
<th valign="top"><b>Is Total Product:</b></th>
<td valign="top" class="field">
<asp:DropDownList ID="F_isTotalProduct" runat="server">
		<asp:ListItem Value="">-- ALL --</asp:ListItem>
		<asp:ListItem Value="1">Yes</asp:ListItem>
		<asp:ListItem Value="0">No</asp:ListItem>
	</asp:DropDownList> <span class="smaller">Total of product</span>
</td>
</tr>
<tr>
...
<CC:GridView id="gvList" CellSpacing="2" CellPadding="2" runat="server" PageSize="50" AllowPaging="True" AllowSorting="True" HeaderText="In order to change display order, please use header links" EmptyDataText="There are no records that match the search criteria" AutoGenerateColumns="False" BorderWidth="0" PagerSettings-Position="Bottom">
	...
	<Columns>
		<asp:TemplateField>
			<ItemTemplate>
			<asp:HyperLink enableviewstate=False runat="server" NavigateUrl= '<%# "edit.aspx?PromotionId=" & DataBinder.Eval(Container.DataItem, "PromotionId") & "&" & GetPageParams(Components.FilterFieldType.All) %>' ImageUrl="/includes/theme-admin/images/edit.gif" ID="lnkEdit">Edit</asp:HyperLink>
			</ItemTemplate>
		</asp:TemplateField>
		<asp:TemplateField>
			<ItemTemplate>
			<CC:ConfirmLink enableviewstate=False Message="Are you sure that you want to remove this Store Promotion?" runat="server" NavigateUrl= '<%# "delete.aspx?PromotionId=" & DataBinder.Eval(Container.DataItem, "PromotionId") & "&" & GetPageParams(Components.FilterFieldType.All) %>' ImageUrl="/includes/theme-admin/images/delete.gif" ID="lnkDelete">Delete</CC:ConfirmLink>
			</ItemTemplate>
		</asp:TemplateField>
		...
		<asp:BoundField SortExpression="CustomerPriceGroupCode" DataField="CustomerPriceGroupCode" HeaderText="Customer Price Group"></asp:BoundField>
		...
		<asp:Checkboxfield ItemStyle-HorizontalAlign="Center" SortExpression="IsRegisterSend" DataField="IsRegisterSend" HeaderText="Is Register Send"/>
