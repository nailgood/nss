...
Partial Class SpecificItems
    ...
    Private Sub BindList()
        ...
        sSQL &= " spi.ID, spi.PromotionId, si.ItemId As RecordId, si.ItemName, 'Item' As ItemType FROM StoreItem si, StorePromotionItem spi"
    ...
    Private Sub btnAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        Try
            ...
            dbPromotion.InsertRelatedItem(Request.Form("ItemId"))
