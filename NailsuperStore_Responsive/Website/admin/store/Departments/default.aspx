<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/includes/masterpage/admin.master" Title="" CodeFile="default.aspx.vb" Inherits="admin_store_departments__default"  %>
...
<p>
                ...
                <table border="0" cellpadding="2" cellspacing="0" class="view" width="280">
                    ...
                    <tr>
                        ...
                        <td><%--Department/Class Name:<br>
                            <asp:TextBox Text="" id="NewDepartment" Runat="server" />
                            &nbsp;--%>
                            <asp:Button runat="server" ID="btnAdd" Text="Add Department" cssclass="btn" />
                        </td>
                    </tr>
                </table>
                <p>
                    <table border="0" cellpadding="2" cellspacing="0" class="view" width="280">
                        ...
                        <tr>
                            ...
                            <td>Department/Class Name:<br>
                                ...
                                &nbsp;
                                <asp:Button id="btnRename" cssclass="btn" Text="Rename" Runat="server" />
                            </td>
                        </tr>
                    </table>
                </p><p>
                    <table border="0" cellpadding="2" cellspacing="0" class="view" width="280">
                        ...
                        <tr>
                            ...
                            <td>Delete selected department/class&nbsp;
                                <asp:Button id="btnDelete" cssclass="btn" Text="Delete" Runat="server" />
                            </td>
                        </tr>
                    </table>
                </p>
   ...
   <%-- <hr size=1 color=black>
    ...
    <font class="desc">Please select source and destination department/class and then click 
        the </font>&nbsp;<asp:Button ID="btnMove" cssclass="btn" value="Move" Runat="server" Text="Move" Visible="false" />
