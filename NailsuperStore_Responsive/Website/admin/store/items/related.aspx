<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/includes/masterpage/admin.master" Title="" CodeFile="related.aspx.vb" Inherits="admin_store_items_related"  %>
<asp:content ContentPlaceHolderId="ph" ID="Content" runat="server">
	...
	function InitializeQuery() {
	    InitQueryCode('LookupField', '/admin/ajax.aspx?f=DisplayItemsAndCollections&q=', 'divSearch');
	}
	...
	<h4>Coordinating items for '<asp:label ID="lblItemName" Runat="server" />'</h4>
	<br>
	<a href="default.aspx?<%=params%>">лл Go Back To Item List</a>
	<p><b>Add Coordinating Item</b>
				...
				<tr>
					...
					<td class="field" width="400">
						...
						<p>
							...
							<br>
						Please click the "Add Coordinating Item" button below to add the item selected as a coordinating item"
						<p>
							<asp:button id="btnAdd" runat="server" Text="Add Coordinating Item" cssClass="btn"></asp:button></p>
					</td>
					<td valign="top">
					</td>
				</tr>
	...
	<p>
		<b>View/Update Existing Coordinating Items</b>
				...
				<td width="435">
					<asp:DataGrid BorderWidth="0" PageSize="20" AllowPaging="True" AllowSorting="True" CellPadding="2"
						...
						<Columns>
							<asp:TemplateColumn>
								<ItemTemplate>
									<CC:ConfirmLink enableviewstate=False Message="Are you sure that you want to remove this item?" runat="server" NavigateUrl= '<%# "CollectionDelete.aspx?sType=Related&ParentId=" & DataBinder.Eval(Container.DataItem, "ParentId") & "&ItemId=" & DataBinder.Eval(Container.DataItem, "ItemId") & "&" & params %>' ImageUrl="/includes/theme-admin/images/delete.gif" ID="Confirmlink1"/>
								</ItemTemplate>
							</asp:TemplateColumn>
							...
							<asp:TemplateColumn>
								<ItemTemplate>
									<asp:HyperLink enableviewstate=False runat="server" NavigateUrl= '<%# "move.aspx?sTable=RelatedItem&ACTION=UP&ParentId=" & DataBinder.Eval(Container.DataItem, "ParentId") & "&Id=" & DataBinder.Eval(Container.DataItem, "Id")  & "&" & params %>' ImageUrl="/includes/theme-admin/images/moveup.gif" ID="Hyperlink2"/>
								</ItemTemplate>
							</asp:TemplateColumn>                                
							<asp:TemplateColumn>
								<ItemTemplate>
									<asp:HyperLink enableviewstate=False runat="server" NavigateUrl= '<%# "move.aspx?sTable=RelatedItem&ACTION=DOWN&ParentId=" & DataBinder.Eval(Container.DataItem, "ParentId") & "&Id=" & DataBinder.Eval(Container.DataItem, "Id")  & "&" & params %>' ImageUrl="/includes/theme-admin/images/movedown.gif" ID="Hyperlink3"/>
								</ItemTemplate>
							</asp:TemplateColumn>                                
