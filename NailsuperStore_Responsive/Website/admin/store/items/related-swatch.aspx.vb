...
Partial Class admin_store_items_relatedswatch
    Inherits AdminPage
    ...
    Private Sub BindDataGrid()
        ...
        ' BUILD QUERY
        SQL = ""
        SQL &= " SELECT rs.Id, rs.ParentId, si.ItemId, si.SKU, si.ItemName, si.IsActive FROM StoreItem si, RelatedSwatch rs"
        SQL &= " where si.ItemId = rs.ItemId"
        SQL &= "   and rs.ParentId = " & DB.Quote(ItemId)
        SQL &= " ORDER BY rs.SortOrder"
    ...
    Private Sub btnAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        Try
            ...
            dbItem.InsertRelatedSwatch(Request.Form("ItemId"))
            DB.CommitTransaction()

            Response.Redirect("related-swatch.aspx?ItemId=" & ItemId & "&" & GetPageParams(FilterFieldType.All))
