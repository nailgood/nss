<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Song.aspx.vb" Inherits="admin_store_Album_Song" MasterPageFile="~/includes/masterpage/admin.master" %>
...
<asp:Content ContentPlaceHolderID="ph" ID="Content" runat="server">
    ...
    <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server">
        ...
        <tr>
                ...
                <td valign="top" class="field">
                    <asp:DropDownList ID="F_Album" runat="server"></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <th valign="top">
            ...
            <tr>
                <td colspan="2" align="right">
                    ...
                    <input class="btn" type="submit" value="Clear" onclick="window.location='Song.aspx';return false;" />
                </td>
            </tr>
        </table>
    </asp:Panel>
    ...
    <p></p>
    <CC:OneClickButton ID="AddNew" runat="server" Text="Add Song" CssClass="btn"></CC:OneClickButton>
    <p></p>
    ...
    <CC:GridView ID="gvList" CellSpacing="2" CellPadding="2" runat="server" PageSize="50"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Name" HeaderStyle-Width="250" HeaderText="Name"></asp:BoundField>
            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Active">
                <ItemTemplate>
                    <asp:ImageButton ID="imbActive" runat="server" ImageUrl="/images/admin/active.png"
                        CommandName="Active" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "SongId")%>' />
                </ItemTemplate>
            </asp:TemplateField>
             <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Edit">
                <ItemTemplate>
                    <asp:HyperLink EnableViewState="False" runat="server" NavigateUrl='<%# "editSong.aspx?id=" & DataBinder.Eval(Container.DataItem, "SongId") & "&" & GetPageParams(Components.FilterFieldType.All) %>'
