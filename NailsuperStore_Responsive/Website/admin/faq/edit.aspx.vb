...
Public Class admin_faq_Edit
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        phReplies.Visible = Not dbFaq.Email = Nothing
    ...
    Private Sub LoadFromDB()
        ...
        txtSubject.Text = SysParam.GetValue("FaqReplySubject")
        txtFromName.Text = SysParam.GetValue("FaqReplyFromName")
        txtFromEmail.Text = SysParam.GetValue("FaqReplyFromEmail")
        ...
        chkIsMyOrderPage.Checked = dbFaq.IsMyOrderPage
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            dbFaq.IsMyOrderPage = chkIsMyOrderPage.Checked
