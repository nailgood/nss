<%@ Page Language="VB" AutoEventWireup="false" CodeFile="edit.aspx.vb" MasterPageFile="~/includes/masterpage/admin.master" Inherits="admin_faq_Edit"  Title="FAQ" ValidateRequest="false"%>
...
<table border="0" cellspacing="1" cellpadding="2">
	...
	<tr>
		...
		<td><asp:RequiredFieldValidator ID="rfvFaqCategoryId" runat="server" Display="Dynamic" ControlToValidate="drpFAQCategoryId" CssClass="msgError" ErrorMessage="Field 'FAQ Category' is blank"></asp:RequiredFieldValidator></td>
	</tr>
	<tr>
		...
		<td><asp:RequiredFieldValidator ID="rfvQuestion" runat="server" Display="Dynamic" ControlToValidate="txtQuestion" CssClass="msgError" ErrorMessage="Field 'Question' is blank"></asp:RequiredFieldValidator></td>
	</tr>
	<tr>
		<td class="optional">Answer:<div class="smaller" style="font-weight:normal;">Required for active FAQ's</div></td>
		<td class="field"><asp:TextBox TextMode="MultiLine" id="txtAnswer" runat="server" Width="600" Height="300" /></td>
		<td></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="required"><b>Show on My Order page?</b></td>
		<td class="field"><asp:CheckBox runat="server" ID="chkIsMyOrderPage" /></td>
	</tr>
</table>
...
<ContentTemplate>
	...
	<table border="0" cellspacing="1" cellpadding="2">
		...
		<tr>
			...
			<td><asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" Display="Dynamic" ControlToValidate="txtFromName" CssClass="msgError" ErrorMessage="Field 'From Name' is blank"></asp:RequiredFieldValidator></td>
		</tr>
		<tr>
			...
			<td><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic" ControlToValidate="txtFromEmail" CssClass="msgError" ErrorMessage="Field 'From Email' is blank"></asp:RequiredFieldValidator><CC:EmailValidator Display="Dynamic" runat="server" id="EmailValidator1" ControlToValidate="txtFromEmail" CssClass="msgError" ErrorMessage="Field 'Email' is invalid" /></td>
		</tr>
		<tr>
			...
			<td><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Display="Dynamic" ControlToValidate="txtSubject" CssClass="msgError" ErrorMessage="Field 'Subject' is blank"></asp:RequiredFieldValidator></td>
		</tr>
		<tr>
			...
			<td><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Display="Dynamic" ControlToValidate="txtMessage" CssClass="msgError" ErrorMessage="Field 'Your Message' is blank"></asp:RequiredFieldValidator></td>
		</tr>
	</table>
	</asp:Panel>
