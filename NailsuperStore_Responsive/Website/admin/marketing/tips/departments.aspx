<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/includes/masterpage/admin.master" Title="" CodeFile="departments.aspx.vb" Inherits="admin_store_tips_departments"  %>
<asp:content ContentPlaceHolderId="ph" ID="Content" runat="server">
	...
	<h4>Tip departments for tip '<asp:label ID="lblItemName" Runat="server" />'</h4>
	<br>
	<a href="default.aspx?<%=params%>">лл Go Back To Tip List</a>
	<p><b>Add Tip Department</b>
		<table cellSpacing="2" cellPadding="3" border="0">
			<TBODY>
				<tr>
					<td class="optional" valign="top"><b>Department search</b></td>
					<td class="field" width="400">
						Please enter the first few characters of the department name or SKU below<br>
						...
						<p>
							...
							<br>
						Please click the "Add Department" button below to add the department selected as a tip department
						<p>
							<asp:button id="btnAdd" runat="server" Text="Add Department" cssClass="btn" Enabled="False"></asp:button></p>
					</td>
					<td valign="top">
					</td>
				</tr>
	...
	<p>
		<b>View/Update Existing Tip Departments</b>
				...
				<td width="435">
					<asp:DataGrid BorderWidth="0" PageSize="20" AllowPaging="True" AllowSorting="True" CellPadding="2"
						...
						<Columns>
							<asp:TemplateColumn>
								<ItemTemplate>
									<CC:ConfirmLink enableviewstate=False Message="Are you sure that you want to remove this item?" runat="server" NavigateUrl= '<%# "itemsdelete.aspx?TipId=" & DataBinder.Eval(Container.DataItem, "TipId") & "&Id=" & DataBinder.Eval(Container.DataItem, "DepartmentId") & "&sType=Department&" & params %>' ImageUrl="/includes/theme-admin/images/delete.gif" ID="Confirmlink1"/>
								</ItemTemplate>
							</asp:TemplateColumn>
		...
		<P>There are currently no tip departments for this tip.</asp:placeholder>
</asp:content>