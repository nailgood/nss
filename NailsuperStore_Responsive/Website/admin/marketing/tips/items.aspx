<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/includes/masterpage/admin.master" Title="" CodeFile="items.aspx.vb" Inherits="admin_store_tips_items"  %>
<asp:content ContentPlaceHolderId="ph" ID="Content" runat="server">
	...
	<h4>Tip items for tip '<asp:label ID="lblItemName" Runat="server" />'</h4>
	<br>
				...
				<tr>
					...
					<td class="field" width="400">
						...
						<p>
							...
							<br>
						Please click the "Add Item" button below to add the item selected as a tip item
						<p>
	...
	<p>
		<b>View/Update Existing Tip Items</b>
				...
				<td width="435">
					<asp:DataGrid BorderWidth="0" PageSize="20" AllowPaging="True" AllowSorting="True" CellPadding="2"
						...
						<Columns>
							<asp:TemplateColumn>
								<ItemTemplate>
									<CC:ConfirmLink enableviewstate=False Message="Are you sure that you want to remove this item?" runat="server" NavigateUrl= '<%# "itemsdelete.aspx?TipId=" & DataBinder.Eval(Container.DataItem, "TipId") & "&Id=" & DataBinder.Eval(Container.DataItem, "ItemId") & "&sType=Item&" & params %>' ImageUrl="/includes/theme-admin/images/delete.gif" ID="Confirmlink1"/>
								</ItemTemplate>
							</asp:TemplateColumn>
		...
		<P>There are currently no tip items for this tip.</asp:placeholder>
</asp:content>