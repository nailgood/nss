...
Partial Class admin_store_tips_departments
    Inherits AdminPage
    ...
    Private Sub BindDataGrid()
        ...
        ' BUILD QUERY
        SQL = ""
        SQL &= " SELECT td.Id, td.tipid, sd.departmentId, sd.Name, case when sd.IsinActive = 0 then 1 else 0 end as isactive FROM Storedepartment sd, Tipdepartment td"
        SQL &= " where sd.DepartmentId = td.DepartmentId"
        SQL &= "   and td.tipid = " & DB.Quote(TipId)

        lblItemName.Text = DB.ExecuteScalar("SELECT Title FROM Tip WHERE TipId = " & TipId)
        Trace.Write(SQL)
    ...
    Private Sub btnAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        Try
            ...
            dbTip.InsertTipDepartment(Request.Form("DepartmentId"))
