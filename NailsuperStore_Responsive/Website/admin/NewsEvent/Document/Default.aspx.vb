...
Partial Class admin_NewsEvent_Document_Default
    Inherits AdminPage
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            If gvList.SortBy = String.Empty Then gvList.SortBy = "DocumentName"
    ...
    Private Sub BindListData()
        ...
        SQLFields = "SELECT TOP " & (gvList.PageIndex + 1) * gvList.PageSize & " DocumentId,DocumentName,FileName,IsActive"
        SQL = " FROM Document d "

        If Not F_Name.Text = String.Empty Then
            SQL = SQL & Conn & "d.DocumentName LIKE " & DB.FilterQuote(F_Name.Text)
            Conn = " AND "
        End If
    ...
    Protected Sub gvList_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvList.RowCommand
        ...
        ElseIf e.CommandName = "Active" Then
            DocumentRow.ChangeIsActive(DB, e.CommandArgument)
        End If
        BindListData()
    End Sub
