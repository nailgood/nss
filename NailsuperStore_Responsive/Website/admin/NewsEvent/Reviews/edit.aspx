<%@ Page Title="" Language="VB" MasterPageFile="~/includes/masterpage/admin.master" AutoEventWireup="false" CodeFile="edit.aspx.vb" Inherits="admin_NewsEvent_Reviews_edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ph" Runat="Server">
    ...
    <table border="0" cellspacing="1" cellpadding="2">
        ...
        <tr>
            ...
            <td class="field">
                <asp:HyperLink ID="hplNews" runat="server"></asp:HyperLink>
            </td>
            <td>
            </td>
        </tr>
