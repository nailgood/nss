<%@ Page Language="VB" AutoEventWireup="false" CodeFile="default.aspx.vb" MasterPageFile="~/includes/masterpage/admin.master"
    Inherits="admin_news" Title="News" Debug="true" %>
...
<asp:Content ContentPlaceHolderID="ph" ID="Content" runat="server">
   ...
   <script type="text/javascript" src="/includes/scripts/tinymce/tinymce.min.js"></script>
    ...
    <div style="margin: 0 20px">
        <h4><asp:Literal ID="ltrHeader" runat="server" Text="List News"></asp:Literal></h4>
        <asp:Panel ID="pnNew" runat="server" Visible="false">
            <table border="0" cellspacing="1" cellpadding="2">
                ...
                <tr>
                    ...
                    <td class="field">
                        <asp:TextBox ID="txtPageTitle" runat="server" MaxLength="255" Width="700px" TextMode="SingleLine"></asp:TextBox></asp:TextBox><%= Resources.Admin.lenPageTitle%>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td class="field">
                        <asp:TextBox ID="txtMetaKeyword" runat="server" MaxLength="2000" Width="700px" TextMode="MultiLine"></asp:TextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td class="field">
                        <asp:TextBox ID="txtMetaDescription" runat="server" MaxLength="2000" Width="700" Height="120"
                            TextMode="MultiLine"></asp:TextBox></asp:TextBox><%= Resources.Admin.lenMetaDesc%>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td class="field">
                        <CC:FileUpload ID="fuImage" AutoResize="true" Folder="/assets/NewsImage" ImageDisplayFolder="/assets/NewsImage/MainThumb"
                ...
                <tr>
                    ...
                    <td class="field">
                        <asp:TextBox ID="txtAudioName" runat="server" MaxLength="128" Width="700px" TextMode="SingleLine"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="optional">
                    ...
                    <td class="field">
                        <asp:TextBox ID="txtAudioUrl" runat="server" MaxLength="128" Width="700px" TextMode="SingleLine"></asp:TextBox>
                    </td>
                </tr>
        ...
        <asp:Panel ID="pnList" runat="server">
            ...
            <CC:GridView ID="gvList" CellSpacing="2" CellPadding="2" runat="server" PageSize="50"
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Document">
                        <ItemTemplate>
