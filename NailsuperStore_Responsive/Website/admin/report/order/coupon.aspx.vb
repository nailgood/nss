...
Partial Class admin_store_report_coupon
    Inherits AdminPage
    ...
    Private Sub BindList()
        ...
        SQL = " FROM Vie_PromotionReport si "
        ...
        Dim resProCus As DataSet
        Dim i As Integer
        Dim PromotionCode As String = ""
        For i = 0 To res.Tables(0).Rows.Count - 1
            PromotionCode = res.Tables(0).Rows(i)("PromotionCode")
            resProCus = DB.GetDataSet("select * from Vie_PromotionCustomerReport")
            res.Tables(0).Rows(i)("PromotionCode") = PromotionCode  ' "<SPAN style='COLOR: blue ;TEXT-DECORATION : underline' onmouseover=this.style.cursor='hand';this.style.textDecoration='none';this.style.color='blue'	onmouseout=this.style.textDecoration='underline';this.style.color='blue' onclick=ViewPromotionCustomer('" & PromotionCode & "','" & PromotionCode & "','" & PromotionCode & "')> " & PromotionCode & " </SPAN>"
        Next
