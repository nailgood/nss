...
Public Class admin__faq_index
    ...
    Private Sub BindRepeater()
        ...
        SQL = " SELECT FaqId, Question, SortOrder, case isActive when 1 then '<font color=green><b>YES</b></font>' else '<font color=red><b>no</b></font>' end As IsActive FROM Faq f ORDER BY f.SortOrder ASC "
