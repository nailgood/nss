<%@ Page Language="VB" MasterPageFile="~/includes/masterpage/admin.master" AutoEventWireup="false"
    CodeFile="Edit.aspx.vb" Inherits="admin_MediaPress_Category_Edit" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ph" runat="Server">
    ...
    <table border="0" cellspacing="1" cellpadding="2">
        ...
        <%-- <tr>
            ...
            <td class="field">
                <asp:TextBox ID="txtLinkDetail" runat="server" MaxLength="255" TextMode="SingleLine" Columns="50" Style="width: 419px;"></asp:TextBox>
            </td>
            <td>
