...
Partial Class admin_KeyWord_ReportByKeyword_KeywordDetail
    Inherits AdminPage
    ...
    Private Sub BindList()
        ...
        Dim dt As DataTable = KeywordSearchRow.GetDetailListForKeyword(KeywordId, gvList.SortBy, gvList.SortOrder, gvList.PageIndex + 1, gvList.PageSize, total)
