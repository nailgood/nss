<%@ Page Language="VB" AutoEventWireup="false" CodeFile="edit.aspx.vb" MasterPageFile="~/includes/masterpage/admin.master" Inherits="admin_customers_Edit"  Title="Customer"%>
...
<table border="0" cellspacing="1" cellpadding="2">
	...
	<tr>
		...
		<td><CC:EmailValidator runat="server" ControlToValidate="txtEmail" CssClass="msgError" ErrorMessage="Please enter a valid email address" /></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="optional">Last Export:</td>
		<td class="field"><asp:Label ID="Label1" runat="server" /></td>
		<td></td>
	</tr>
	<tr>
