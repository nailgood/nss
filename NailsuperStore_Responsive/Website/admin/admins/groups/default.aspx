<%@ Page Language="VB" MasterPageFile="~/includes/masterpage/admin.master" AutoEventWireup="false" CodeFile="default.aspx.vb" Inherits="admin_admins_groups_index" title="User Group Administration" %>
<asp:Content ID="Content" ContentPlaceHolderID="ph" Runat="Server">

<h4>User Group Administration</h4>

<p>
<asp:button id="AddNew" cssClass="btn" Text="Add New User Group" Runat="server"></asp:button>
</p>
...
<asp:datagrid id="dgList" runat="server" PageSize="20" AllowPaging="True" AutoGenerateColumns="False"
        ...
        <Columns>
            <asp:TemplateColumn>
                <ItemTemplate>
                    <asp:HyperLink enableviewstate="False" runat="server" NavigateUrl= '<%# "edit.aspx?GroupId=" & DataBinder.Eval(Container.DataItem, "GroupId")  & "&" & params %>' ImageUrl="/includes/theme-admin/images/edit.gif" ID="Hyperlink2">Edit</asp:HyperLink>
                </ItemTemplate>
            </asp:TemplateColumn>
            <asp:TemplateColumn>
                <ItemTemplate>
                    <CC:ConfirmLink enableviewstate="False" Message="Are you sure that you want to remove this group?" runat="server" NavigateUrl= '<%# "delete.aspx?GroupId=" & DataBinder.Eval(Container.DataItem, "GroupId") & "&" & params %>' ImageUrl="/includes/theme-admin/images/delete.gif" ID="Confirmlink1">Delete</CC:ConfirmLink>
                </ItemTemplate>
            </asp:TemplateColumn>
            <asp:TemplateColumn SortExpression="Y">
                <HeaderTemplate>
                    ...
                    <asp:LinkButton enableviewstate="False" visible='<%#Viewstate("F_SortBy") = "DESCRIPTION" and Viewstate("F_SortOrder") = "ASC" %>' CommandArgument="DESCRIPTION" CommandName="sort" id="Linkbutton2" runat="server">
                        <img border="0" src="/includes/theme-admin/images/Asc3.gif" alt="Ascending"></asp:LinkButton>
                    <asp:LinkButton enableviewstate="False" visible='<%#Viewstate("F_SortBy") = "DESCRIPTION" and Viewstate("F_SortOrder") = "DESC" %>' CommandArgument="DESCRIPTION" CommandName="sort" id="Linkbutton3" runat="server">
                        <img border="0" src="/includes/theme-admin/images/Desc3.gif" alt="Descending"></asp:LinkButton>
                </HeaderTemplate>
                <ItemTemplate>
