    ...
    Public Class MailingGroupRow
        ...
        Public Shared ReadOnly Property GetSelectedMailingLists(ByVal db As Database, ByVal GroupId As Integer) As String
            Get
                ...
                Try
                    dr = db.GetReader("select ListId from MailingGroupList where GroupId = " & GroupId)
        ...
        Public ReadOnly Property GetSelectedMailingListNames() As String
            Get
                ...
                Dim dr As SqlDataReader = Nothing
                Try
                    dr = DB.GetReader("select ml.Name from MailingGroupList mgl, MailingList ml where mgl.ListId = ml.ListId and mgl.GroupId = " & GroupId)
                    Dim Conn As String = String.Empty
                    While dr.Read()
                        Result &= Conn & dr("Name")
                        Conn = ", "
