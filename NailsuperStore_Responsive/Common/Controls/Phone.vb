...
Namespace Controls
    ...
    Public Class Phone
		...
		Public ReadOnly Property Phone1ClientId() As String
			Get
				If phone1 Is Nothing Then
					Return String.Empty
				Else
					Return phone1.ClientID
				End If
			End Get
		End Property

		Public ReadOnly Property Phone2ClientId() As String
			Get
				If phone2 Is Nothing Then
					Return String.Empty
				Else
					Return phone2.ClientID
				End If
			End Get
		End Property

		Public ReadOnly Property Phone3ClientId() As String
			Get
				If phone3 Is Nothing Then
					Return String.Empty
				Else
					Return phone3.ClientID
				End If
			End Get
		End Property
