...
Namespace Controls
    Public Class Zip
		...
		Public ReadOnly Property Zip5ClientId() As String
			Get
				If z5 Is Nothing Then
					Return String.Empty
				Else
					Return z5.ClientID
				End If
		...
		Public ReadOnly Property Zip4ClientId() As String
			Get
				If z4 Is Nothing Then
					Return String.Empty
				Else
					Return z4.ClientID
				End If
